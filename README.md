...
- GRABACIÓN DE LAS 3 VOCES CON MICRÓFONO 3
    ...
    [GRABACIÓN DE LAS 3 VOCES CON MICRÓFONO 3](1elimichel.wav)

- GRABACIÓN SILENCIO MICRÓFONO 3
  
   [GRABACIÓN SILENCIO MICRÓFONO 3](1SILENCIO.wav)

- VOZ GRAVE FILTRADA MICRÓFONO 1
  
   [VOZ GRAVE FILTRADA MICRÓFONO 1](1SILENCIO.wav)

- VOZ GRAVE FILTRADA MICRÓFONO 2

   [VOZ GRAVE FILTRADA MICRÓFONO 2](1SILENCIO.wav)

- VOZ GRAVE FILTRADA MICRÓFONO 3

   [VOZ GRAVE FILTRADA MICRÓFONO 3](1SILENCIO.wav)

- VOZ GRAVE SUMADA FINAL
  
  [VOZ GRAVE SUMADA FINAL](1SILENCIO.wav)
